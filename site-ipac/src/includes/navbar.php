...
<div class="flex justify-between items-center px-5 sm:px-6 md:px-10 lg:px-12 xl:px-20 2xl:px-32 h-10 bg-[#9aaa00]">
  ...
  <a
    href="https://www.instagram.com/ipacanalisedocomportamento/"
    class="flex items-center gap-2 text-[11px] sm:text-xs text-white font-medium"
  >
...
<header class="relative h-20 lg:h-24 border-b border-gray-100 bg-white">
  ...
  <!-- ========================================
       ...
       Essa fica independente do grid.
       Centro REAL da tela.
  ========================================= -->
